...
const I18N_EN={
  ...
  "Этапы маршрута": "Route stages",
  "Режется только отожжённое стекло": "Annealed glass only",
  "Полирует контур (этап 2) и обрабатывает тело стекла (этап 3) — один станок на двух этапах": "Polishes the contour (stage 2) and works the glass body (stage 3) — one machine on two stages",
  "Работает садками, а не поштучно; минимальный размер детали 6 × 12 in": "Runs in batches, not piece by piece; minimum part size 6 × 12 in",
  "Один станок может стоять на нескольких этапах — ЧПУ полирует контур и обрабатывает тело стекла.": "One machine can sit on several stages — the CNC polishes the contour and works the glass body.",
  "Справочники обновлены до новой версии — этапы маршрута и станки приведены к реальному цеху.": "Reference tables refreshed — route stages and machines now match the real shop.",
