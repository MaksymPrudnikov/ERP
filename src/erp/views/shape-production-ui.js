...
shapeMarksBodyHTML=function(){
  ...
  }).join(''):(shapeStampFeatures().length?'':'<div class="empty compact">No manufacturing items yet</div>')}</div>`;
