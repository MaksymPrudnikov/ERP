...
function salesApplyServiceAssignment(){
  ...
  soDraft.lines.forEach(function(line){if(!ids.has(line.id))return;line.serviceSetId='';salesApplySetOpsToShape(line,set);});
  touch();
