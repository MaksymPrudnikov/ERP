...
/* Запас по косой стороне — таблица цеха (владелец, 17 сентября 2026, базовый
   сетап Perfect Cut): 3–6 мм → 1″, 8–12 → 1 1/2″, 15–19 → 3″. До этого в коде
   стояло 16–19 → 1/2″, и на толстом стекле программа считала запас в шесть раз
   меньше, чем режет цех. */
