...
> Текущая точка 17 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, справочник причин, NCR после выдачи и Recut внутри заказа, стикеры 4×6 и 3×4 со штрихкодом и конструктор шаблонов, 740 проверок. Следующая работа — своя раскладка по листам и сканирование стёкол на станциях.
