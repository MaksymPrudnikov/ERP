...
> Текущая точка 16 сентября 2026: очередь Optimization, компактный Sales и батчи отдельных стёкол, 679 проверок. Следующая работа — [`docs/ЗАДАЧА_PR-C.md`](docs/ЗАДАЧА_PR-C.md).
