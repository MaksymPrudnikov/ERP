...
> Текущая точка 17 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, справочник причин и записи NCR, 712 проверок. Следующая работа — стикеры и сканирование стёкол.
