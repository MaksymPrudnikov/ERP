...
Unit Price/Line Total. Columns сохраняет отдельные настройки экрана и печати
по профилю сотрудника в этом браузере. Pricing rules регулирует минимум
...
отсутствующие нормы явно помечены и редактируются в детализации веса.
Правила, ограничения и подтверждения владельца — в шапке handoff v5.0.
