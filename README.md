...
В итоговой строке валюта указана один раз рядом с Entire order, а семь сумм
остаются в постоянных компактных позициях и имеют одинаковый размер. Пользовательский интерфейс всегда
