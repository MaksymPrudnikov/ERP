...
> Текущая точка 22 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, справочник причин, NCR после выдачи и Recut внутри заказа, стикеры 4×6 и 3×4 со штрихкодом и конструктор шаблонов, свой раскрой батча по листам с правками руками и учётом потерь, ручной поворот Shape на 0/90/180/270°, накопительные показатели от первого до открытого листа, 811 проверок. Следующая работа — сканирование стёкол на станциях и отгрузка скидами.
