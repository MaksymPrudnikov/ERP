...
владельцем и записаны в верхнем разделе хендоффа v5.0.

---

## Показатели строки и вид таблицы · 9 сентября 2026

В заказе появились Actual/Rounded/Billable Area, Unit/Line Weight и
Unit Price/Line Total. Columns сохраняет видимость и произвольный порядок
...
минимум к оплате по умолчанию 4 ft². Итоги CAD включают материалы и обработку,
до energy surcharge, налога и доставки. Вес собирается по всем компонентам;
...
Правила, ограничения и подтверждения владельца — в шапке handoff v5.1.
