...
> Текущая точка 16 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, 684 проверки. Следующая работа — [`docs/ЗАДАЧА_PR-C.md`](docs/ЗАДАЧА_PR-C.md).
