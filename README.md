...
> Текущая точка 23 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, справочник причин, NCR после выдачи и Recut внутри заказа, стикеры 4×6 и 3×4 со штрихкодом и конструктор шаблонов, свой раскрой батча по листам с правками руками и учётом потерь, ручной поворот Shape на 0/90/180/270° с прямой кнопкой 180°, пустой лист через `+` и удаление через `−`, общие и полистовые показатели в шапке, единые компактные иконки и переходы к первому/последнему листу, подготовка безопасного общего снимка для экспорта Maver и Disai, 817 проверок. Следующая работа — проверенные станочные файлы, затем сканирование стёкол на станциях и отгрузка скидами.
