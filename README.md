...
> Текущая точка 17 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, справочник причин NCR, 699 проверок. Следующая работа — записи NCR по номеру стекла, стикеры и сканирование.
