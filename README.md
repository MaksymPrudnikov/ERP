...
> Текущая точка 17 сентября 2026: очередь Optimization, компактный Sales, батчи отдельных стёкол с Glass ID, справочник причин, NCR после выдачи и Recut внутри заказа, 721 проверка. Следующая работа — стикеры и сканирование стёкол.
