...
Сборка **10a4666f06d7** · 16 сентября 2026. Снимки сняты с собранного HTML,
с демонстрационными заказами. Макеты одобрены владельцем перед реализацией.

## Уточнение после проверки владельцем

Новые стрелки используют тот же знак ▾, что фильтры колонок; закрытая навигация — ▸.
История заказа стала тонкой полосой: точка и название на одной линии, даты выводятся
только у состоявшихся этапов. Пустые строки под будущие даты убраны.
На узком экране полоса прокручивается горизонтально.
...
![Компактная история нового заказа](sales-compact-screenshots/sales-order-strip-built.png)
