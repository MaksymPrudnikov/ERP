...
module.exports=async function({page,eq,ok}){
 ...
 }),{before:{button:'Service +',labels:['Subtotal','ES 9.75%','HST 13%','Total'],currency:'CAD',currencyCount:1,amountCurrencyCount:0,amountFontSizes:['12px'],noLaptopOverflow:true},initial:{checked:2,rates:[9.75,13,2.34,0,0],cards:['visa','mastercard','amex']},after:[242,23.6,34.53,7.02,500,750,1557.15],shown:true,slots:7,printButton:false});
